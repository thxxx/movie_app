...

{
    ...
    LENGTH = numof_numbers;
    NUMTO_THREAD = LENGTH / numof_thread;
    OFFSET = LENGTH % numof_thread;
    ...
    merge_sections_of_array(arr, numof_thread, 1);
